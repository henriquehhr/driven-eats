...
function getPrecoTotal() {
    return itensSelecionados.prato.preco + itensSelecionados.sobremesa.preco + itensSelecionados.bebida.preco;
}
function confirmarPedido() {
    const modal = document.querySelector(".overlay");
    modal.classList.remove("escondido");
    document.querySelector(".confirmar-pedido .prato .nome").innerHTML = itensSelecionados.prato.nome;
    document.querySelector(".confirmar-pedido .prato .preco").innerHTML = itensSelecionados.prato.preco.toFixed(2);
    document.querySelector(".confirmar-pedido .bebida .nome").innerHTML = itensSelecionados.bebida.nome;
    document.querySelector(".confirmar-pedido .bebida .preco").innerHTML = itensSelecionados.bebida.preco.toFixed(2);
    document.querySelector(".confirmar-pedido .sobremesa .nome").innerHTML = itensSelecionados.sobremesa.nome;
    document.querySelector(".confirmar-pedido .sobremesa .preco").innerHTML = itensSelecionados.sobremesa.preco.toFixed(2);
...
pratos.forEach((prato)=>{
    const pratoView = new (0, _itemDefault.default)(prato, "prato", itensSelecionados);
...
bebidas.forEach((bebida)=>{
    const bebidaView = new (0, _itemDefault.default)(bebida, "bebida", itensSelecionados);
...
sobremesas.forEach((sobremesa)=>{
    const sobremesaView = new (0, _itemDefault.default)(sobremesa, "sobremesa", itensSelecionados);
...
},{"./Item":"6Qx2R","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6Qx2R":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
